/**
 * Created by Nich Osborn on March 24, 2016

 Answer to Problem 2 starts on Line 75.
 */
"use strict";
...
// Problem 2 Code begins here.
        ...
        f.iterate = function() {
            ...
            while(index < l.length - 1) {
                var j = getNext(current);
                document.writeln(", " + j.data);
                current = j;

            };

// Problem 2 code ends here.
        };
...
document.writeln("<BR>Begin test: <BR>")
l4.iterate();
document.writeln("<BR>End test.<BR>")
